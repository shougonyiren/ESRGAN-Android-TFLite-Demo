...
import com.lh.superresolution.core.huawei.SRHuaweiImage
...
class SRGlideTransformation(var url: String, var SISR_SCALE: Float, var context: Context) :
    ...
    override fun transform(
        ...
        if (SRHuaweiImage.getInstance(context).isDebug) {
        ...
        return SRHuaweiImage.getInstance(context).loadBitmap(toTransform, context, SISR_SCALE)
            ?: toTransform
    }
